...
@Autonomous(name = "RedAuto_2Beacon", group = "code")
public class AutoRed_2Beacon extends OpMode {
    DcMotor motor1;
    DcMotor motor2;
    DcMotor motor3;
    DcMotor motor4;
    ...
    final static double[] e2 = {-70, -70, 80};
    ...
    public AutoRed_2Beacon() throws InterruptedException
    {
    ...
    public void loop()
    {
        switch (moveNumber) {
            ...
            case 2:
                ...
                else if (colorReading.time() < 4.25)
                {
