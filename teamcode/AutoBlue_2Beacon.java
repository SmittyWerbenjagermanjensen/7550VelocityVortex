...
@Autonomous(name = "BlueAuto_2Beacon", group = "code")
public class AutoBlue_2Beacon extends OpMode {
    DcMotor motor1;
    DcMotor motor2;
    DcMotor motor3;
    DcMotor motor4;
    ...
    final static double[] e1 = {-twentyTwoPointFiveDegreeTurn, twentyTwoPointFiveDegreeTurn, 50};
    final static double[] e2 = {-71.5, -71.5, 80};
    final static double[][] finalPath = {e1, e2};
    ...
    public AutoBlue_2Beacon() throws InterruptedException
    {
    ...
    public void loop()
    {
        switch (moveNumber) {
            ...
            case 5:
                motor4.setPower(0);
                moveMatrix(2, 1, 20, beaconTwoPath);
                colorReading.reset();
                buttonPusher.setPosition(0.5);
                break;
